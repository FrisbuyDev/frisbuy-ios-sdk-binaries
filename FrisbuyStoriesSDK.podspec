...
spec.author             = { "Frisbuy" => "..." }
spec.source             = { :git => 'https://gitlab.com/frisbuy-public/frisbuy-ios-sdk-binaries', :tag => '1.0.33' }
# :git => 'https://gitlab.com/frisbuy-public/frisbuy-ios-sdk-binaries', :tag => '1.0.31' }
