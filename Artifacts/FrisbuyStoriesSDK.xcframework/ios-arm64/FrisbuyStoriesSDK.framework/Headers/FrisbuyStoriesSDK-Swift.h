...
#ifndef FRISBUYSTORIESSDK_SWIFT_H
#define FRISBUYSTORIESSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FrisbuyStoriesSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17FrisbuyStoriesSDK28AnimatedCollectionViewLayout")
...
SWIFT_CLASS("_TtC17FrisbuyStoriesSDK38AnimatedCollectionViewLayoutAttributes")
...
SWIFT_CLASS("_TtC17FrisbuyStoriesSDK9CoverView")
...
SWIFT_CLASS("_TtC17FrisbuyStoriesSDK14FrisbuyStories")
@interface FrisbuyStories : UICollectionViewController
- (void)loadView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC17FrisbuyStoriesSDK11ProgressHUD")
